	...
	return (
		<section>
			<div className="rounded-2xl bg-linear-to-l from-primary to-purple-600 p-8 text-center text-white shadow-xl md:p-12">
				...
				<p
					className="mx-auto mt-4 max-w-2xl text-indigo-100"
					suppressHydrationWarning>
				...
				<Link href="/#products">
					<button
						className="mt-8 rounded-full bg-white px-8 py-4 text-lg font-semibold text-primary transition hover:bg-indigo-50"
						suppressHydrationWarning>
						شروع خرید
					</button>
				</Link>
